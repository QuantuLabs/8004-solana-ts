...
// ============ CONFIG ============
const HELIUS_API_KEY = 'b79b8798-6e81-4c49-8e79-f0b786e81e4e';
const HELIUS_DEVNET_RPC = `https://devnet.helius-rpc.com/?api-key=${HELIUS_API_KEY}`;

// Pinata JWT from 8004-solana-mcp/.env
const PINATA_JWT = process.env.PINATA_JWT || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..iJLoBGk724Wy2twPPqS7Aj2OsHDEwjxkhITs20IMMVM';
