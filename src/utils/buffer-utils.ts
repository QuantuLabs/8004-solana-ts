 ...
 */
export function readBigUInt64LE(buffer: Uint8Array, offset: number = 0): bigint {
 ...
 */
export function serializeString(str: string, maxLength: number = MAX_SERIALIZED_STRING_LENGTH): Buffer {
