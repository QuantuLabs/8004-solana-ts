...
Indexer validation reads are archived (`v0.5.0+`): `getValidations`, `getValidationsByValidator`, `getPendingValidations`, and `getValidation` remain for compatibility but intentionally throw archived-feature errors.
