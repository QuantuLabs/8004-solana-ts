...
const agentConfigs: AgentConfig[] = [
  ...
  },
  {
    ...
    metadata: [
      { key: 'greeting', value: 'Hello! 你好! こんにちは! Привет! مرحبا!' },
      { key: 'symbols', value: '©®™€£¥§¶†‡' },
      { key: 'math', value: '∑∏∫√∞≈≠±×÷' },
    ],
  },
  ...
  },
  {
    ...
    metadata: [
      ...
      { key: 'data', value: Buffer.from('Binary test data 🚀').toString('base64') },
    ],
  },
];
...
async function main() {
  ...
  console.log('='.repeat(70));
  console.log('  ✓ Empty strings (token_uri, nft_symbol)');
  console.log('  ✓ Short strings');
  console.log('  ✓ Long strings (>100 chars)');
  console.log('  ✓ Unicode characters (emoji, accents)');
  console.log('  ✓ Special characters');
  console.log('  ✓ No metadata (empty Vec)');
  console.log('  ✓ Single metadata entry');
  console.log('  ✓ Multiple metadata entries');
  console.log('  ✓ JSON-encoded values');
  console.log('  ✓ Base64-encoded values');
  console.log('  ✓ Numeric values as strings');
  console.log('  ✓ IPFS URIs');
  console.log('  ✓ Arweave URIs');
  console.log('='.repeat(70) + '\n');
}
